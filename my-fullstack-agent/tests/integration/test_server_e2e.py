...
def start_server() -> subprocess.Popen[str]:
    ...
    env["AGENT_ENGINE_SESSION_NAME"] = "test-my-fullstack-agent"
...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    session_url = f"{BASE_URL}/apps/financial_advisor/users/{user_id}/sessions"
...
def cleanup_agent_engine_sessions() -> None:
    ...
    try:
        ...
        agent_name = os.environ.get(
            "AGENT_ENGINE_SESSION_NAME", "my-fullstack-agent"
        )
